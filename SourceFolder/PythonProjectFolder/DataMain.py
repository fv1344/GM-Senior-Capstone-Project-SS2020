...
if update_ars_forecast:
    ...
    # (forecast_first_date, forecast_last_date, history_amount, average, insert, is_test, show_output)
    my.calculate_ars_forecast('2020-07-27', '2020-08-27', 20, False, True, False, True)
